...
ActiveRecord::Schema.define(:version => 20150902011614) do
  ...
  create_table "accounting_service_order_positions", :force => true do |t|
    t.integer  "accounting_service_order_id", :null => false
  ...
  create_table "payroll_payroll_type_personal_types", :force => true do |t|
    t.integer "payroll_payroll_type_id",  :null => false
    t.integer "payroll_personal_type_id", :null => false
  end

  create_table "payroll_payroll_types", :force => true do |t|
    t.string "name", :null => false
  end
  ...
  create_table "payroll_process_regular_payrolls", :force => true do |t|
  ...
  create_table "payroll_regular_payroll_checks", :force => true do |t|
    ...
    t.datetime "updated_at"
    t.integer  "paid_by_id"
    t.integer  "payroll_process_regular_payroll_id"
    t.integer  "total_employees_paid",                                              :default => 0
    t.decimal  "total_amount_allocation",            :precision => 20, :scale => 2, :default => 0.0
    t.decimal  "total_amount_deduction",             :precision => 20, :scale => 2, :default => 0.0
    t.decimal  "total_amount_paid",                  :precision => 20, :scale => 2, :default => 0.0
  end
  ...
  create_table "product_by_invoices", :force => true do |t|
    t.integer  "invoice_id",                                                         :default => 1
    t.integer  "product_id",                                                                          :null => false
    t.integer  "quantity",                                                                            :null => false
    t.float    "side_dimension_x",                                                   :default => 0.0, :null => false
    t.float    "side_dimension_y",                                                   :default => 0.0, :null => false
